...
begin
	...
	reset(arch);
	assign(txt, 'Ejercicio1SinDNI.txt');
	rewrite(txt);
...
procedure eliminarDato(var arch: archivo);
var
...
begin
	...
	if(encontre) then
		writeln('Dato borrado correctamente.')
	else
...
begin
	...
	writeln('8 - Eliminar un dato ingresado por teclado');
	readln(opcion);
