### 4. Suponiendo Selective Repeat; tamaño de ventana 4 y sabiendo que E indica que el mensajea llegó con errores. Indique en el siguiente gráfico, la numeración de los ACK que el host B envía al host A.
